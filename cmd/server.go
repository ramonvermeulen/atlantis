...
const (
	...
	DisableHighCardinalityMetricsFlag = "disable-high-cardinality-metrics"
...
var boolFlags = map[string]boolFlag{
	...
	DisableHighCardinalityMetricsFlag: {
		description:  "Disable high-cardinality metrics (such as per-PR metrics) to prevent memory leaks.",
		defaultValue: false,
	},
